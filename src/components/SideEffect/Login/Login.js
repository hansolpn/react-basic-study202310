...
const emailReducer = (state, action) => {
  ...
  // dispatch 함수가 전달한 액션 객체의 타임에 따라 변경할 상태값을 반환
...
const passwordReducer = (state, action) => {
  console.log('password reducer called!');
...
const Login = ({ onLogin }) => {
  // email reducer 사용하기
  /*
    param1- reducer function
    param2 - initial state: 초기 상태값
    return1 - 이메일 관련 상태 변수
    return2 - dispather함수: 상태를 변경할 수 있는 함수
  */
  ...
  // emailState는 객체 형태 -> isValid 프로퍼티가 변경됬을 때만 useEffect를 실행하게 하려면
